...
import com.dangdoan.app.weather.webservices.WeatherMapHttpRequest;

import org.json.JSONObject;

public class JsonVolleyLoader extends VolleyLoader{
    private static final String TAG = JsonVolleyLoader.class.getSimpleName();
    ...
    private void deliverResult(VolleyLoaderData vData){
